...
export class CartRelations1720654408562 implements MigrationInterface {
    name = 'CartRelations1720654408562'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cart_item\` ADD \`quantity\` int NOT NULL`);

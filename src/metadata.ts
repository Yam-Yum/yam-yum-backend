  ...
  return {
    '@nestjs/swagger': {
      models: [
        ...
        [
          import('./order/entities/order.entity'),
          {
            Order: {
              ...
              phoneNumber: { required: true, type: () => String },
              status: { required: true, enum: t['./order/entities/order.entity'].OrderStatus },
              itemsSubtotal: { required: true, type: () => Number },
              shippingFee: { required: true, type: () => Number },
              discount: { required: true, type: () => Number },
              orderTotal: { required: true, type: () => Number },
              paymentMethod: { required: true, type: () => String },
              createdAt: { required: true, type: () => Date },
              updatedAt: { required: true, type: () => Date },
              address: { required: true, type: () => t['./users/entities/address.entity'].Address },
              recipes: {
                required: true,
        ...
        [
          import('./users/entities/address.entity'),
          {
            Address: {
              id: { required: true, type: () => String },
              title: { required: true, type: () => String },
              longtude: { required: true, type: () => Number },
              ...
              apartmentNumber: { required: true, type: () => String },
              houseNumber: { required: true, type: () => String },
              officeNumber: { required: true, type: () => String },
              additionalDirections: { required: true, type: () => String },
              postalCode: { required: true, type: () => Number },
              addressType: {
                required: true,
                enum: t['./users/entities/address.entity'].AddressType,
              },
              ...
              updatedAt: { required: true, type: () => Date },
              user: { required: true, type: () => t['./users/entities/user.entity'].User },
              orders: { required: true, type: () => [t['./order/entities/order.entity'].Order] },
            },
          },
        ],
        [
          import('./cart/entities/cartItem.entity'),
          {
            CartItem: {
              id: { required: true, type: () => String },
              quantity: { required: true, type: () => Number },
              recipe: { required: true, type: () => t['./recipe/entities/recipe.entity'].Recipe },
              cart: { required: true, type: () => t['./cart/entities/cart.entity'].Cart },
              isActive: { required: true, type: () => Boolean },
              createdAt: { required: true, type: () => Date },
              updatedAt: { required: true, type: () => Date },
            },
        ...
        [
          import('./cart/entities/cart.entity'),
          {
            Cart: {
              id: { required: true, type: () => String },
              user: { required: true, type: () => t['./users/entities/user.entity'].User },
              cartItems: {
                required: true,
                type: () => [t['./cart/entities/cartItem.entity'].CartItem],
              },
              isActive: { required: true, type: () => Boolean },
              createdAt: { required: true, type: () => Date },
              updatedAt: { required: true, type: () => Date },
        ...
        [
          import('./review/entities/review.entity'),
          {
            Review: {
              id: { required: true, type: () => String },
              rating: { required: true, enum: t['./review/entities/review.entity'].ReviewRate },
        ...
        [
          import('./users/entities/user.entity'),
          {
            User: {
              ...
              addresses: {
                required: true,
                type: () => [t['./users/entities/address.entity'].Address],
              },
              cart: { required: true, type: () => t['./cart/entities/cart.entity'].Cart },
              orders: { required: true, type: () => [t['./order/entities/order.entity'].Order] },
              reviews: {
        ...
        [
          import('./recipe/entities/recipe.entity'),
          {
            Recipe: {
              ...
              orderCount: { required: true, type: () => Number },
              createdAt: { required: true, type: () => Date },
              updatedAt: { required: true, type: () => Date },
              images: {
                required: true,
        ...
        [
          import('./users/dto/create-address.dto'),
          {
            CreateAddressDto: {
              userId: { required: true, type: () => String },
              ...
              apartmentNumber: { required: false, type: () => String },
              houseNumber: { required: false, type: () => String },
              officeNumber: { required: false, type: () => String },
              additionalDirections: { required: false, type: () => String },
        ...
        [
          import('./order/dto/recipe.dto'),
          {
            RecipeDTO: {
              recipeId: { required: true, type: () => String },
              quantity: { required: true, type: () => Number, minimum: 0 },
            },
          },
        ],
        [
          import('./users/dto/assign-to-me-.dto'),
          {
            AssignToMeDto: {
              cartRecipes: { required: true, type: () => [t['./order/dto/recipe.dto'].RecipeDTO] },
              addressIds: { required: true, type: () => [String] },
              orderIds: { required: true, type: () => [String] },
              favoriteRecipeIds: { required: true, type: () => [String] },
            },
          },
        ],
        [
        ...
        [
          ...
          {
            RecipeQueryDto: {
              searchKeyword: { required: false, type: () => String },
              status: { required: false, enum: t['./recipe/entities/recipe.entity'].RecipeStatus },
              recipeIds: { required: true, type: () => [String] },
              size: { required: false, enum: t['./recipe/entities/recipe.entity'].RecipeSize },
              categoryId: { required: false, type: () => String },
              authorId: { required: false, type: () => String },
              rateGreaterThan: { required: false, type: () => Number },
              rateLessThan: { required: false, type: () => Number },
              sortByRate: { required: false, type: () => Object },
              sortByDate: { required: false, type: () => Object },
              sortByPrice: { required: false, type: () => Object },
        ...
        [
          import('./cart/dto/update-cart-quantity.dto'),
          {
        ...
        [import('./order/dto/update-order.dto'), { UpdateOrderDto: {} }],
        [
          import('./order/dto/place-order.dto'),
          {
            PlaceOrderDto: {
              fullName: { required: true, type: () => String },
              phoneNumber: { required: true, type: () => String },
              addressId: { required: true, type: () => String },
              recipes: { required: true, type: () => [t['./order/dto/recipe.dto'].RecipeDTO] },
              userId: { required: true, type: () => String },
              paymentMethod: { required: true, type: () => String },
            },
          },
        ...
        [
          import('./order/dto/order-guest.dto'),
          { orderGuestDto: { orderIds: { required: true, type: () => [String] } } },
        ],
      ...
      controllers: [
        ...
        [
          ...
          {
            CartController: {
              updateCartQuantity: { type: Object },
              cartCheckout: {},
              getMyCart: {},
              findAll: { type: String },
              findOne: { type: String },
